...
3.1.1.2 [Загрузка новостей](#download_news)  
3.1.1.3 [Просмотр информации об отдельной новости](#view_information_about_an_individual_newsletter)  
3.1.1.4 [Выход пользователя из учётной записи](#active_user_change)  
3.1.1.5 [Регистрация нового пользователя после входа в приложение](#add_new_user)   
...
1. Приложение не может выводить информацию о каталоге с экипировкой без наличия информации в базе данных.
...
#### 3.1.1.2 Загрузка списка снаряжения
**Описание.** После входа пользователя в приложение или после завершения регистрации необходимо загрузить список экипировки и отсортировать по названию в алфавитном порядке.

| Функция | Требования | 
|:---|:---|
| Загрузка информации о экипировки | Приложение должно загрузить информацию о экипировки после входа пользователя в приложение или после завершения регистрации |

<a name="view_information_about_an_individual_newsletter"/>

#### 3.1.1.3 Просмотр информации об отдельном снаряжении
**Описание.** Пользователь имеет возможность просмотреть информацию о каждом снаряжении, представленном в списке.

| Функция | Требования | 
|:---|:---|
| Просмотр информации о снаряжении | Пользователь имеет возможность выбрать снаряжении в списке одинарным кликом по нему. Приложение должно открыть окно, содержащее полную информацию о снаряжении, а также кнопку добавлении данного снаряжения в корзину|
